          ...
          modules = [
            {
              ...
              # Share secrets directory from hypervisor via virtiofs
              # Hypervisor fetches secrets using its AWS IAM role
              microvm.shares = [
                {
              ...
              virtualisation.oci-containers = {
                ...
                containers = {
                  sandbox = {
                    ...
                    # Load environment variables from secret file shared from hypervisor
